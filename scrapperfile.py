...
def pharmeasy_scrapper(pharm_link):
  ...
  pharm_med_names = pharm_soup.find_all(class_="ProductCard_medicineName__17En6")
  pharm_med_prices = pharm_soup.find_all(class_="ProductCard_ourPrice__3fkJf")
  pharm_half_med_links = pharm_soup.find_all(name="a",
                                             class_="ProductCard_medicineUnitWrapper__238qP ProductCard_defaultWrapper__3htqi")
  pharm_med_names_list = []
  pharm_med_prices_list = []
...
def appolo_scrapper(app_link):
  ...
  app_med_names = app_soup.find_all(class_="ProductCard_productName__2LhTY")
  app_med_prices = app_soup.find_all(class_="ProductCard_priceGroup__Xriou")
  app_half_med_links = app_soup.find_all(name="a", class_="ProductCard_proDesMain__gigTv")
  app_med_names_list = []
  app_med_prices_list = []
